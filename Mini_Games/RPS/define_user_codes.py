...
with open('/var/www/Mini_Games/RPS/Computer_Generated_Files/user_codes.json', 'r') as file:
    data = json.load(file)
...
with open("/var/www/Mini_Games/RPS/Computer_Generated_Files/user_codes.py", "w") as file:
    file.write(file_out)
