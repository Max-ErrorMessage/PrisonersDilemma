...
session_start();
$filePath = '/var/www/twokie.com/Mini_Games/Yahtzee/fetch_code.php';
...
file_put_contents("/var/www/twokie.com/Mini_Games/Yahtzee/Computer_Generated_Files/user_codes.json", $json_codes);

$output = exec("python3 /var/www/twokie.com/Mini_Games/Yahtzee/define_user_codes.py");
...
file_put_contents('/var/www/twokie.com/Mini_Games/Yahtzee/Computer_Generated_Files/scores.json', $json_empty_scores);
...
foreach ($user_codes as $user_code_1) {
    ...
    $command = "timeout 1 python3 /var/www/twokie.com/Mini_Games/Yahtzee/simulate_2_players.py $arg1 $arg2";
...
$json_file = '/var/www/twokie.com/Mini_Games/Yahtzee/Computer_Generated_Files/scores.json';
