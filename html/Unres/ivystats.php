...
FROM (
    SELECT 
        w.provided_archetype AS archetype,
        COUNT(*) AS wins,
        0 AS losses
    FROM tournament t
    JOIN decks w ON w.id = t.winnerid
    GROUP BY w.provided_archetype

    UNION ALL

    SELECT 
        l.provided_archetype AS archetype,
        0 AS wins,
        COUNT(*) AS losses
    FROM tournament t
    JOIN decks l ON l.id = t.loserid
...
<head>
    ...
    <meta property="og:image" content="https://www.twokie.com/Unres/images/ivy.png">
            ...
            <div class="bg-fg">
                ...
                <div id="lb">
                    <div id = "page1">
                        ...
                        <br>
                        <h2> Tourney Start </h2>
                        <canvas id="piegraph" style="width:80%; height:600px;"></canvas>
                        <h2> After Round 1 </h2>
                        <canvas id="piegraph2" style="width:80%; height:600px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
