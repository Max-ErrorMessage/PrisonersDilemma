            ...
            <div class="bg-fg">
                ...
                <div id="lb">
                    <div id = "page1">
                        ...
                        <br>
                        <h2> Tourney Start </h2>
                        <canvas id="piegraph" style="width:80%; height:600px; left:10%; position:absolute;"></canvas>
                        <h2> After Round 1 </h2>
                        <canvas id="piegraph2" style="width:80%; height:600px; left:10%; position:absolute;"></canvas>
                    </div>
                </div>
            </div>
        </div>
