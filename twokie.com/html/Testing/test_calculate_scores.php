...
session_start();
$filePath = '/var/www/twokie.com/twokie.com/Mini_Games/Prisoners_Dilemma/fetch_code.php';
...
file_put_contents("/var/www/twokie.com/twokie.com/Mini_Games/Prisoners_Dilemma/Computer_Generated_Files/user_codes.json", $json_codes);

$output = exec("python3 /var/www/twokie.com/twokie.com/Mini_Games/Prisoners_Dilemma/define_user_codes.py");
...
file_put_contents('/var/www/twokie.com/twokie.com/Mini_Games/Prisoners_Dilemma/Computer_Generated_Files/scores.json', $json_empty_scores);
...
foreach ($user_codes as $user_code_1) {
    ...
    foreach ($user_codes as $user_code_2) {
        ...
        $command = "timeout 1 python3 /var/www/twokie.com/twokie.com/Mini_Games/Prisoners_Dilemma/simulate_2_players.py $arg1 $arg2 $arg3";
...
include '/var/www/twokie.com/twokie.com/html/db.php';

$json_file = '/var/www/twokie.com/twokie.com/Mini_Games/Prisoners_Dilemma/Computer_Generated_Files/scores.json';
